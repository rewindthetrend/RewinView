...
<head>
    @include('front_partials._head')
</head>
<body>
@include('front_partials._toptext')
@include('front_partials._title_bar')
@include('front_partials._nav_bar')
    ...
    <div class="row mx-0">
      ...
      @foreach ($posts as $post)
        ...
        <div class="col-md-6 col-12 paddding animate-box" data-animate-effect="fadeIn">
            <div class="fh5co_suceefh5co_height"><img src="images/{{ ($post->image) }}"  width="960" height="640" alt="img"/>
                <div class="fh5co_suceefh5co_height_position_absolute"></div>
                <div class="fh5co_suceefh5co_height_position_absolute_font">
                    <div class=""><a href="#" class="color_fff"> <i class="fa fa-clock-o"></i>&nbsp;&nbsp;{{ date('M j, Y', strtotime($post->created_at)) }}
                    </a></div>
                    <div class=""><a href="#" class="fh5co_good_font">{{ substr($post->description,0 ,50) }}{{ strlen($post->description)> 50 ? "...": ""}}</a></div>
                </div>
            </div>
        </div>
        <?php $count++; ?>
            ...
            <div class="row">
              ...
              @foreach ($sports as $post)
                ...
                <div class="col-md-6 col-6 paddding animate-box" data-animate-effect="fadeIn">
                    <div class="fh5co_suceefh5co_height_2"><img src="images/{{ ($post->image) }}" width="480" height="300" alt="img"/>
                        <div class="fh5co_suceefh5co_height_position_absolute"></div>
                        <div class="fh5co_suceefh5co_height_position_absolute_font_2">
                            <div class=""><a href="#" class="color_fff"> <i class="fa fa-clock-o"></i>&nbsp;&nbsp;{{ date('M j, Y', strtotime($post->created_at)) }}</a></div>
                            <div class=""><a href="#" class="fh5co_good_font_2">{{ substr($post->description,0 ,50) }}{{ strlen($post->description)> 50 ? "...": ""}}</a></div>
                        </div>
                    </div>
                </div>
                 <?php $count++; ?>
            ...
            <div class="item px-2">
                <div class="fh5co_latest_trading_img_position_relative">
                    ...
                    <div class="fh5co_latest_trading_img_position_absolute_1">
                        <a href="#" class="text-white"> Here's a new way to take better photos for instagram </a>
...
<div class="container-fluid fh5co_footer_bg pb-3">
  ...
  @include('front_partials._footer')

<div class="gototop js-top">
    <a href="#" class="js-gotop"><i class="fa fa-arrow-up"></i></a>
</div>
  @include('front_partials._scripts')
