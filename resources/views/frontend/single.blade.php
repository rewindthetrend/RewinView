...
<div id="fh5co-title-box" style="background-image: url(images/{{ ($sports->image) }}); background-position: 50% 90.5px;" data-stellar-background-ratio="0.5">
  
    <div class="page-title">
        <img src="images/{{ ($sports->image) }}" alt="img">
        <h2>Heading 2</h2>
    </div>
</div>
